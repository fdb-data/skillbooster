...
const api = {
  ...
  validation: {
    ...
    addCase: (sceneId: string, input: unknown): Promise<unknown> => ipcRenderer.invoke('validation:addCase', sceneId, input),
    updateCase: (sceneId: string, caseId: string, input: unknown): Promise<unknown> => ipcRenderer.invoke('validation:updateCase', sceneId, caseId, input),
    deleteCase: (sceneId: string, caseId: string): Promise<unknown> => ipcRenderer.invoke('validation:deleteCase', sceneId, caseId),
    runReplay: (sceneId: string, caseIds?: string[]): Promise<unknown> => ipcRenderer.invoke('validation:runReplay', sceneId, caseIds),
